<template>
	<section class="main__article article">
		...
		<h2>Key Features</h2>
		<ol>
			<li><strong>Simplicity: </strong>Our components are designed with simplicity in mind. You don't need to be an expert to get started. Just select the component you need, copy the code snippet, and paste it into your project.</li>
			<li><strong>No Extra Dependencies: </strong>We understand the importance of keeping your projects lightweight. That's why our components are self-contained and don't rely on any additional external libraries.</li>
			<li><strong>Versatility: </strong>From sortable lists to draggable cards, our library offers a wide range of components suitable for various use cases. You'll find the perfect tools to enhance your application's usability and interactivity.</li>
		</ol>
	</section>
</template>