<template>
  <section class="main__example example">
    ...
    <Avatar
      @upload="uploadFile"
      @delete="items = ['Files must be in jpeg or png format.']"
    />
    <CodePre :items="items" />
    <PropsList :list="propsList" />
    <PropsList :list="emitsList" emit />
    <ButtonsList
      link="https://github.com/skiff26/dragdrop/blob/main/src/components/examples/Avatar.vue"
    />
  </section>
</template>
...
const propsList = [
  {
    name: 'trash',
    text: 'Boolean - add trash for delete image. Default = true.'
  }
]
