<template>
	<section class="main__example example">
		<h1 class="example__title">Handle</h1>
		<Handle :items="items" />
		<CodePre :items="items" />
		<PropsList :list="propsList" />
		<ButtonsList link="https://github.com/skiff26/dragdrop/blob/main/src/components/examples/Handle.vue"/> 
	</section>
</template>

<script setup>
import { ref } from 'vue'
import Handle from '@/components/examples/Handle.vue'
