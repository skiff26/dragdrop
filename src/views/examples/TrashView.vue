<template>
  <section class="main__example example">
    <h1 class="example__title">Trash</h1>
    <Trash :items="items" />
    <CodePre :data="items" />
    <PropList :list="props" />
    <ButtonList>
      <ViewCodeButton url="https://github.com/skiff26/dragdrop/blob/main/src/components/examples/Trash.vue" />
    </ButtonList>
  </section>
</template>
...
<script setup>
import { ref } from 'vue'
import Trash from '@/components/examples/Trash.vue'
