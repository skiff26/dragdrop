<template>
	<div class="demo">
		...
		<div class="drop-zone">
			<h3>Remove item</h3>
			<div class="drop-trash" 
			@dragstart="startDrag($event)"
			@drop="onDrop($event)"
			@dragover.prevent="onOverTrash($event)"
			@dragleave.prevent="onLeaveTrash($event)"
			@dragenter.prevent
			>
				<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" viewBox="0 0 16 16" data-testid="trash">
